...
getLineFitFromCoda <- function(codaSamplesLogitCenter, # Coda Samples 
  ...
  codaSummary <- summary(codaSamplesLogitCenter)
...
getLineFitFromCoda(codaSamplesLogitCenter, dataList, valuesOf = 'p')    

# Plot the lines and fit for yhat
getLineFitFromCoda(codaSamplesLogitCenter, dataList, valuesOf = 'yhat') 
```
