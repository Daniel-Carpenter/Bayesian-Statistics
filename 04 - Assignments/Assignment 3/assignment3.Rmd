...
3. Posterior distribution is used as the hypothetical distribution of parameter values for
power analysis
...
mcmcCoda = genMCMC( data=idealDatFrm, saveName=NULL, numSavedSteps=2000, thinSteps=20 )
