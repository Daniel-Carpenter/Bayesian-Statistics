...
N = 8000 # Specify the total number of flips, denoted N.
iters = 5000
df <- c()
  
for (i in 1:iters) {
  df$outcome <- rbind(df$outcome, runProp(N))
}

print(paste0("Expected Value of N, given ", iters, " simulations of size ", N))
mean(df$outcome)
